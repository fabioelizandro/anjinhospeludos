...
angular.module('app.oauth', [
    ...
    'app.oauth.accessToken', // access token service
    'oauth.endpoint', // oauth endpoint service
    'oauth.profile', // profile model
    'oauth.interceptor'     // bearer token interceptor
]);

angular.module('app.oauth.accessToken', ['ngCookies'])
        .factory('AccessToken', ['$rootScope', '$location', '$cookieStore', '$interval', function ($rootScope, $location, $cookieStore, $interval) {

            var service = {
                token: null
            };
            
            var oAuth2HashTokens = [//per http://tools.ietf.org/html/rfc6749#section-4.2.2
            ...
            var setTokenFromSession = function () {
                if ($cookieStore.get('token')) {
                    var params = $cookieStore.get('token');
            ...
            var setTokenInSession = function () {
                $cookieStore.put('token', service.token);
            };
